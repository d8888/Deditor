...
function pickTheme()
{
	//listEditorThemes is generated by genfile.ahk
	Swal.fire({
		title: 'Select theme',
		input: 'select',
		...
		console.log(result);
		editor.setOption("theme", result.value);
		//var color = document.getElementsByClassName("CodeMirror")[0].style.background;
		var elem = document.getElementsByClassName("CodeMirror")[0];
		...
		sendRequest("activate2","#bgcolor:"+color);
	})
}
